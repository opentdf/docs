...
func main() {
	...
	// Use sdk.ForClientID to create an EntityIdentifier in one call.
	// Other helpers: sdk.ForEmail, sdk.ForUserName, sdk.ForToken, sdk.WithRequestToken
	entitlementReq := &authorizationv2.GetEntitlementsRequest{
		EntityIdentifier: sdk.ForClientID("opentdf"),
	}
