...
Use [`validateAttributes`](/sdks/discovery#validateattributes) to confirm that all FQNs exist on the platform before creating a TDF. This prevents silent policy mismatches.
:::
