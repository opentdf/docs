...
|-----------|------|----------|-------------|
| `subjectSets` | `[]SubjectSet` | Yes | One or more subject sets. Each contains condition groups with conditions that match against entity token claims. Subject sets are evaluated with AND logic. |
