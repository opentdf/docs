...
2. Delete the problematic profile: `otdfctl profile delete platform-otdf-local`
3. Recreate with TLS verification disabled: `otdfctl profile create --tls-no-verify platform-otdf-local https://platform.opentdf.local:8443`
4. Set it as default: `otdfctl profile set-default platform-otdf-local`
