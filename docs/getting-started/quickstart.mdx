...
├────────────────────────────────────────┼──────────────┼────────┼────────┼─────────────────────┼────────────────────────┤
│0d94e00a-7bd3-4482-afe3-f1e4b03c1353    │example.org   │true    │[]      │Fri Jan 30 18:55:26…│Fri Jan 30 18:55:26 UT…│
│87ba60e1-da12-4889-95fd-267968bf0896    │scenario.com  │true    │[]      │Fri Jan 30 18:55:26…│Fri Jan 30 18:55:26 UT…│
│8f1d8839-2851-4bf4-8bf4-5243dbfe517d    │example.com   │true    │[]      │Fri Jan 30 18:55:26…│Fri Jan 30 18:55:26 UT…│
│d69cf14d-744b-48cf-aab4-43756e97a8e5    │example.net   │true    │[]      │Fri Jan 30 18:55:26…│Fri Jan 30 18:55:26 UT…│
└────────────────────────────────────────┴──────────────┴────────┴────────┴─────────────────────┴────────────────────────┘
```

</details>

These are a few example namespaces that come pre-configured with the platform. You'll create your own namespace in the next section.
...
No output expected for this and every following export command.
...
A `subject mapping` connects users to attributes, **granting them entitlements**. This is the "What can this entity access?" part of our authorization system.

**Entitlements** are the attribute values a user possesses. When a user tries to decrypt a document, the platform will check their entitlements and make an authorization **decision** by comparing them to the document's required attributes.
...
No output expected. This creates an encrypted file called `executive-strategy.tdf`.
...
No output expected. This creates an encrypted file called `finance-report.tdf`.
