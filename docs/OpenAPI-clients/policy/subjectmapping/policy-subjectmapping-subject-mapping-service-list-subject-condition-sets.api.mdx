...
<Heading
  ...
  children={"ListSubjectConditionSets"}
>
</Heading>

<MethodEndpoint
  method={"post"}
  path={"/policy.subjectmapping.SubjectMappingService/ListSubjectConditionSets"}
  context={"endpoint"}
>
