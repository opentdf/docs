...
<Heading
  ...
  children={"CreateSubjectConditionSet"}
>
</Heading>

<MethodEndpoint
  method={"post"}
  path={"/policy.subjectmapping.SubjectMappingService/CreateSubjectConditionSet"}
  context={"endpoint"}
>
