---
title: otdfctl auth client-credentials
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Authenticate to the platform with the client-credentials flow\",\"command\":{\"name\":\"client-credentials\",\"args\":[\"client-id\"],\"arbitrary_args\":[\"client-secret\"]},\"fullCommand\":\"otdfctl auth client-credentials\"}")}>
