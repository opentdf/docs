---
title: otdfctl policy obligations triggers delete
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Delete an obligation trigger\",\"command\":{\"name\":\"delete\",\"flags\":[{\"name\":\"id\",\"description\":\"ID of the obligation trigger to delete\",\"required\":true},{\"name\":\"force\",\"description\":\"Force deletion without interactive confirmation\"}]},\"fullCommand\":\"otdfctl policy obligations triggers delete\"}")}>
