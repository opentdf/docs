---
title: otdfctl policy actions delete
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Delete a Custom Action\",\"command\":{\"name\":\"delete\",\"flags\":[{\"name\":\"id\",\"shorthand\":\"i\",\"description\":\"ID of the custom action\",\"required\":true},{\"name\":\"force\",\"description\":\"Force deletion without interactive confirmation\"}]},\"fullCommand\":\"otdfctl policy actions delete\"}")}>
