---
title: otdfctl policy attributes key assign
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Assign a KAS key to an attribute definition\",\"command\":{\"name\":\"assign\",\"flags\":[{\"name\":\"attribute\",\"shorthand\":\"a\",\"description\":\"URI or ID of the attribute definition\",\"required\":true},{\"name\":\"key-id\",\"shorthand\":\"k\",\"description\":\"ID of the KAS key to assign\",\"required\":true}]},\"fullCommand\":\"otdfctl policy attributes key assign\"}")}>
