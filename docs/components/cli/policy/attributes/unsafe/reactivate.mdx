---
title: otdfctl policy attributes unsafe reactivate
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Reactivate an attribute definition\",\"command\":{\"name\":\"reactivate\",\"flags\":[{\"name\":\"id\",\"shorthand\":\"i\",\"description\":\"ID of the attribute definition\",\"required\":true}]},\"fullCommand\":\"otdfctl policy attributes unsafe reactivate\"}")}>
