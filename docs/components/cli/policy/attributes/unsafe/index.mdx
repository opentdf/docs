---
title: otdfctl policy attributes unsafe
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Unsafe changes to attribute definitions\",\"command\":{\"name\":\"unsafe\",\"flags\":[{\"name\":\"force\",\"description\":\"Force unsafe change without confirmation\",\"required\":false}]},\"fullCommand\":\"otdfctl policy attributes unsafe\"}")}>
