---
title: otdfctl policy attributes namespaces key assign
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Assign a KAS key to an attribute namespace\",\"command\":{\"name\":\"assign\",\"flags\":[{\"name\":\"namespace\",\"shorthand\":\"n\",\"description\":\"Can be URI or ID of namespace\",\"required\":true},{\"name\":\"key-id\",\"shorthand\":\"k\",\"description\":\"ID of the KAS key to assign\",\"required\":true}]},\"fullCommand\":\"otdfctl policy attributes namespaces key assign\"}")}>
