---
title: otdfctl policy attributes namespaces key remove
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Remove a KAS key from an attribute namespace\",\"command\":{\"name\":\"remove\",\"flags\":[{\"name\":\"namespace\",\"shorthand\":\"n\",\"description\":\"Can be URI or ID of namespace\",\"required\":true},{\"name\":\"key-id\",\"shorthand\":\"k\",\"description\":\"ID of the KAS key to remove\",\"required\":true}]},\"fullCommand\":\"otdfctl policy attributes namespaces key remove\"}")}>
