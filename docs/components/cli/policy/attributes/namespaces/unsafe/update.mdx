---
title: otdfctl policy attributes namespaces unsafe update
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Update an attribute namespace\",\"command\":{\"name\":\"update\",\"flags\":[{\"name\":\"id\",\"shorthand\":\"i\",\"description\":\"ID of the attribute namespace\",\"required\":true},{\"name\":\"name\",\"shorthand\":\"n\",\"description\":\"Name of the attribute namespace (new)\",\"required\":true}]},\"fullCommand\":\"otdfctl policy attributes namespaces unsafe update\"}")}>
