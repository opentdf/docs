---
title: otdfctl policy attributes deactivate
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Deactivate an attribute definition\",\"command\":{\"name\":\"deactivate\",\"flags\":[{\"name\":\"id\",\"shorthand\":\"i\",\"description\":\"ID of the attribute\",\"required\":true},{\"name\":\"force\",\"description\":\"Force deactivation without interactive confirmation (dangerous)\"}]},\"fullCommand\":\"otdfctl policy attributes deactivate\"}")}>
