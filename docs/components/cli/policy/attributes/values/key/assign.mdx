---
title: otdfctl policy attributes values key assign
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Assign a KAS key to an attribute value\",\"command\":{\"name\":\"assign\",\"flags\":[{\"name\":\"value\",\"shorthand\":\"v\",\"description\":\"URI or ID of attribute value\",\"required\":true},{\"name\":\"key-id\",\"shorthand\":\"k\",\"description\":\"ID of the KAS key to assign\",\"required\":true}]},\"fullCommand\":\"otdfctl policy attributes values key assign\"}")}>
