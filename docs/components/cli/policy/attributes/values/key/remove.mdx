---
title: otdfctl policy attributes values key remove
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Remove a KAS key from an attribute value\",\"command\":{\"name\":\"remove\",\"flags\":[{\"name\":\"value\",\"shorthand\":\"v\",\"description\":\"URI or ID of attribute value\",\"required\":true},{\"name\":\"key-id\",\"shorthand\":\"k\",\"description\":\"ID of the KAS key to remove\",\"required\":true}]},\"fullCommand\":\"otdfctl policy attributes values key remove\"}")}>
