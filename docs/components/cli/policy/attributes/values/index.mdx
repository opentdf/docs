---
title: otdfctl policy attributes values
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Manage attribute values\",\"command\":{\"name\":\"values\",\"aliases\":[\"val\",\"value\"]},\"fullCommand\":\"otdfctl policy attributes values\"}")}>
