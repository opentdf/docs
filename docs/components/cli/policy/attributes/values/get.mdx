---
title: otdfctl policy attributes values get
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Get an attribute value\",\"command\":{\"name\":\"get\",\"aliases\":[\"g\"],\"flags\":[{\"name\":\"id\",\"shorthand\":\"i\",\"description\":\"The ID of the attribute value to get\"}]},\"fullCommand\":\"otdfctl policy attributes values get\"}")}>
