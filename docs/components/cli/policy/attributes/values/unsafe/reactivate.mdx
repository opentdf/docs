---
title: otdfctl policy attributes values unsafe reactivate
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Reactivate an attribute value\",\"command\":{\"name\":\"reactivate\",\"flags\":[{\"name\":\"id\",\"shorthand\":\"i\",\"description\":\"ID of the attribute value\",\"required\":true}]},\"fullCommand\":\"otdfctl policy attributes values unsafe reactivate\"}")}>
