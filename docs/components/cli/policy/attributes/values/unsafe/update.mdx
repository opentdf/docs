---
title: otdfctl policy attributes values unsafe update
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Update an attribute value\",\"command\":{\"name\":\"update\",\"flags\":[{\"name\":\"id\",\"shorthand\":\"i\",\"description\":\"ID of the attribute value\",\"required\":true},{\"name\":\"value\",\"shorthand\":\"v\",\"description\":\"The new value replacing the current value\"}]},\"fullCommand\":\"otdfctl policy attributes values unsafe update\"}")}>
