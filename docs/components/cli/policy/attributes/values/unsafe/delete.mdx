---
title: otdfctl policy attributes values unsafe delete
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Delete an attribute value\",\"command\":{\"name\":\"delete\",\"flags\":[{\"name\":\"id\",\"shorthand\":\"i\",\"description\":\"ID of the attribute value\",\"required\":true}]},\"fullCommand\":\"otdfctl policy attributes values unsafe delete\"}")}>
