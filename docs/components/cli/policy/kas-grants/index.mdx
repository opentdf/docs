---
title: otdfctl policy kas-grants
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"(Deprecated) Manage Key Access Server grants\",\"command\":{\"name\":\"kas-grants\",\"aliases\":[\"kasg\",\"kas-grant\"]},\"fullCommand\":\"otdfctl policy kas-grants\"}")}>
# Deprecated
