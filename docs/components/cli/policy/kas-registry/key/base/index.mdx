---
title: otdfctl policy kas-registry key base
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Platform Base Key Management\",\"command\":{\"name\":\"base\"},\"fullCommand\":\"otdfctl policy kas-registry key base\"}")}>
