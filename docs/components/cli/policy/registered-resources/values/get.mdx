---
title: otdfctl policy registered-resources values get
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Get a Registered Resource Value\",\"command\":{\"name\":\"get\",\"aliases\":[\"g\"],\"flags\":[{\"name\":\"id\",\"shorthand\":\"i\",\"description\":\"ID of the registered resource value\"},{\"name\":\"fqn\",\"shorthand\":\"f\",\"description\":\"FQN of the registered resource value\"}]},\"fullCommand\":\"otdfctl policy registered-resources values get\"}")}>
