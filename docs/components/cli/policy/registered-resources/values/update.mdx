---
title: otdfctl policy registered-resources values update
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Update a Registered Resource Value\",\"command\":{\"name\":\"update\",\"aliases\":[\"u\"],\"flags\":[{\"name\":\"id\",\"shorthand\":\"i\",\"description\":\"ID of the registered resource value to update\"},{\"name\":\"value\",\"shorthand\":\"v\",\"description\":\"Optional updated value of the registered resource value (must be unique within the Registered Resource)\"},{\"name\":\"action-attribute-value\",\"shorthand\":\"a\",\"description\":\"Optional action attribute values in the format: \\\"<action_id | action_name>;<attribute_value_id | attribute_value_fqn>\\\"\",\"default\":\"\"},{\"name\":\"label\",\"description\":\"Optional metadata \'labels\' in the format: key=value\",\"shorthand\":\"l\",\"default\":\"\"},{\"name\":\"force\",\"description\":\"Force update without interactive confirmation\"}]},\"fullCommand\":\"otdfctl policy registered-resources values update\"}")}>
