---
title: otdfctl policy registered-resources values delete
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Delete a Registered Resource Value\",\"command\":{\"name\":\"delete\",\"flags\":[{\"name\":\"id\",\"shorthand\":\"i\",\"description\":\"ID of the registered resource value\",\"required\":true},{\"name\":\"force\",\"description\":\"Force deletion without interactive confirmation\"}]},\"fullCommand\":\"otdfctl policy registered-resources values delete\"}")}>
