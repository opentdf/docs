---
title: otdfctl policy registered-resources get
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Get a Registered Resource\",\"command\":{\"name\":\"get\",\"aliases\":[\"g\"],\"flags\":[{\"name\":\"id\",\"shorthand\":\"i\",\"description\":\"ID of the registered resource\"},{\"name\":\"name\",\"shorthand\":\"n\",\"description\":\"Name of the registered resource\"}]},\"fullCommand\":\"otdfctl policy registered-resources get\"}")}>
