---
title: otdfctl policy key-management provider
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Provider configuration for Key Management\",\"command\":{\"name\":\"provider\",\"aliases\":[\"p\"]},\"fullCommand\":\"otdfctl policy key-management provider\"}")}>
