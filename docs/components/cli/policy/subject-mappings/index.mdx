---
title: otdfctl policy subject-mappings
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Subject mappings\",\"command\":{\"name\":\"subject-mappings\",\"aliases\":[\"subm\",\"sm\",\"submap\",\"subject-mapping\"]},\"fullCommand\":\"otdfctl policy subject-mappings\"}")}>
