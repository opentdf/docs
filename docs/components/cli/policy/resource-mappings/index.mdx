---
title: otdfctl policy resource-mappings
---

import React from 'react';
import CommandLineDocs from '@site/src/components/CommandLineDocs';

<CommandLineDocs {...JSON.parse("{\"title\":\"Manage resource mappings\",\"command\":{\"name\":\"resource-mappings\",\"aliases\":[\"resm\",\"remap\",\"resource-mapping\"]},\"fullCommand\":\"otdfctl policy resource-mappings\"}")}>
