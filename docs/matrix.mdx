...
[^2]: Unsafe Mutations are operations that can cause unintended consequences to data security. This feature will enable these operations (which are prevented in the management APIs) and bind their execution to audit events. The current workaround is to manually update the database.
...
|                            | Go       | Java     | JavaScript |
| :------------------------- | -------- | -------- | ---------- |
| **Lifecycle**              | Beta     | Alpha    | Alpha      |
| **Support**[^101]          | Official | Official | Official   |
|                            |          |          |            |
| **Encrypt/Decrypt**[^103]  | Stable   | Unstable | Unstable   |
