...
| **Policy**        | Unsafe Mutations[^1]         | Planned      |
...
| - ZTDF[^110]               | Stable   | Unstable | Unstable   |
| - NanoTDF[^111]            | Stable   | Planned  | Unstable   |
| - ABAC[^112]               | Stable   | Unstable | Unstable   |
| - Dissem[^113]             | Unstable | Unstable | Unstable   |
|                            |          |          |            |
| **Service APIs**[^105]     | Stable   | Stable   | Planned    |
| - Authorization[^120]      | Stable   |          |            |
| - Key Access Server[^121]  | Stable   |          |            |
| - Policy: Attributes[^130] | Stable   |          |            |
