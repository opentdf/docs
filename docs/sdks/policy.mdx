...
A **namespace** is the top-level organizational unit for attributes and registered resources. Their FQNs are scoped to a namespace URI (e.g., `https://example.com`).
