...
Some `Get` responses include related objects alongside the requested resource. For example, `GetSubjectConditionSet` returns the condition set plus all subject mappings that reference it:
