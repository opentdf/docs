---
sidebar_position: 3
title: "SDK Architecture: Core vs. Service Client"
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# SDK Architecture: Core vs. Service Client
...
// OpenTDF generates DPoP keys needed for authenticated platform calls.
// Bind them to the auth provider before creating PlatformClient.
