...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `fqns` | `[]string` | Yes | Attribute value FQNs to validate (up to 250 per call). |
...
A list of [attribute value](/sdks/policy#attribute-value-object) FQN strings that the entity is entitled to access.
