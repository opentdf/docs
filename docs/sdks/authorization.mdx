...
The authorization system answers two questions: _"What can this entity access?"_ ([GetEntitlements](#getentitlements)) and _"Can this entity access this specific resource?"_ ([GetDecision](#getdecision)). For batch checks, use [GetDecisionBulk](#getdecisionbulk).
