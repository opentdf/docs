...
You can see concrete option usage in these repository code samples:

- Java full TDF encryption/decryption: `code_samples/java/encrypt-example.mdx` and `code_samples/java/decrypt-example.mdx`
- Java collection nanoTDF samples: `code_samples/java/encrypt-collection-example.mdx` and `code_samples/java/decrypt-collection-example.mdx`
