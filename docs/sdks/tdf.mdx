...
| --- | --- | --- |
| TDF / zTDF workflows | `CreateTDF` / `LoadTDF` | Use for encryption/decryption workflows in the current Go SDK; behavior differs by policy/profile configuration. |
