...
The OpenTDF Project currently provides 3 native sdk's. Go, Java and Javascript. In these sections you will find example code of how to get started with each. 
