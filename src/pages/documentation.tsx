...
export default function Documentation() {
  return (
    <div className="homepage">
      <Head>
        <meta property="og:title" content="OpenTDF Documentation - Complete Developer Resources" />
        <meta property="og:description" content="Comprehensive guides, tutorials, and references for implementing data-centric security with OpenTDF." />
      </Head>
      <Layout title="OpenTDF Documentation" description="Complete developer resources for OpenTDF">
        <Hero
          heading="OpenTDF Documentation: Your Complete Guide to Data-Centric Security"
          callToAction={{
            text: "Start with Your First TDF",
